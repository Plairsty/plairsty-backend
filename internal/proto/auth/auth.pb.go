...
func (x *UserFields) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UserFields) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type RegisterRequest struct {
	...
	User *UserFields `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
}
...
func (x *RegisterRequest) GetUser() *UserFields {
	if x != nil {
		return x.User
	}
	return nil
...
var file_internal_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x22, 0x3d, 0x0a, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64,
	...
	0x65, 0x22, 0x38, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x25, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x66,
	0x69, 0x65, 0x6c, 0x64, 0x73, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x48, 0x0a, 0x10, 0x52,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xb5, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
	...
	0x0b, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x50, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_internal_proto_auth_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_proto_auth_auth_proto_goTypes = []interface{}{
	...
	(*UserFields)(nil),       // 4: auth.user_fields
...
var file_internal_proto_auth_auth_proto_depIdxs = []int32{
	4, // 0: auth.RegisterRequest.user:type_name -> auth.user_fields
	...
	6, // 4: auth.AuthService.Register:output_type -> auth.RegisterResponse
